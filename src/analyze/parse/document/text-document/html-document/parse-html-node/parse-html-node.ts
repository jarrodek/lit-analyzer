 ...
 * @param context
 */
function isSelfClosed(p5Node: IP5TagNode, _context: ParseHtmlContext) {
 ...
 * @param context
 */
function makeHtmlNodeLocation(p5Node: IP5TagNode, _context: ParseHtmlContext): IHtmlNodeSourceCodeLocation {
