...
- If you use Visual Studio Code you can also install the [lit-plugin-maintained](https://marketplace.visualstudio.com/items?itemName=runem.lit-plugin-maintained) extension.
